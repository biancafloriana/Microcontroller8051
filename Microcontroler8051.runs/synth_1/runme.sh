...
HD_PWD='F:/Facultate/An III/sem2/SSC/Microcontroler8051/Microcontroler8051.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU8bit.tcl
